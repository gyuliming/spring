                    ...
                    <div class="card-body">
                        ...
                        <form action="/board/list" method="get">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="checkbox" name="types"
                                       value="w"  ${pageRequestDTO.checkType("w")?"checked":""}>내용
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${dtoList}" var="dto">
                                <tr>
                                    <td>
                                        <a href="/board/read?tno=${dto.tno}"><c:out value="${dto.tno}"/></a>

                                    </td>
                                    <td>
                                        <a href="/board/read?tno=${dto.tno}"><c:out value="${dto.title}"/></a>
                        ...
                        <script>
                            ...
                            /* document.querySelector(".pagination").addEventListener("click", function (e) {
                                    ...
                                    self.location = `/board/list?page=\${num}` //백틱(` `)을 이용해서 템플릿 처리
                                },false)*/
